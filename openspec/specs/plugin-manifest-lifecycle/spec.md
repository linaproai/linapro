...
## Purpose
Define how LinaPro discovers, governs, installs, enables, reviews, upgrades, and removes source and dynamic plugins through a unified manifest-driven lifecycle.
## Requirements
