...
The system SHALL require all directory-level main documentation in the repository to simultaneously provide an English primary document `README.md` and a Chinese mirror document `README.zh_CN.md`.

#### Scenario: Directory already has a main README
- **WHEN** a directory exists with main documentation
- **THEN** the directory simultaneously has English `README.md` and Chinese `README.zh_CN.md`
- **AND** `README.md` is written in English
- **AND** `README.zh_CN.md` is written in Chinese

#### Scenario: Adding new directory documentation
- **WHEN** a developer adds main documentation for a directory
- **THEN** both `README.md` and `README.zh_CN.md` are created in the same change
...
- **THEN** the corresponding `README.zh_CN.md` is updated in the same change
...
- **THEN** they can see English `README.md` and Chinese `README.zh_CN.md`
