...
- [x] 2.2 确认 builtin 隐藏安装/启停/升级/租户策略；卸载展示为置灰；保留详情与管理入口
- [x] 2.3 详情弹窗展示内置插件相关只读信息（如适用）
- [x] 2.4 补充中英文 i18n 文案

## 3. 测试与校验

- [x] 3.1 更新 `TC016`：默认展示 builtin、内置标识、卸载置灰、其它写操作隐藏、详情可用
- [x] 3.2 运行相关单测与 E2E / 静态校验
- [x] 3.3 `openspec validate plugin-management-show-builtin --strict`

## Feedback

- [x] **FB-1**: 插件管理操作列对 builtin 插件展示置灰不可点击的卸载按钮，保持与可卸载行一致的按钮数量与列宽