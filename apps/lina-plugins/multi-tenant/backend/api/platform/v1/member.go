// This file declares platform membership DTOs for the multi-tenant source plugin.

package v1

import "github.com/gogf/gf/v2/frame/g"

// MemberEntity is the platform membership API projection.
...
// MemberListReq defines the platform request for listing tenant members.
type MemberListReq struct {
	g.Meta   `path:"/platform/tenant-members" method:"get" tags:"Platform Tenants" summary:"Get platform tenant member list" dc:"Query tenant memberships across tenants by page." permission:"system:tenant:member:list"`
	PageNum  int   `json:"pageNum" d:"1" v:"min:1" dc:"Page number" eg:"1"`
	PageSize int   `json:"pageSize" d:"10" v:"min:1|max:100" dc:"Number of items per page" eg:"10"`
	TenantId int64 `json:"tenantId" dc:"Tenant ID filter" eg:"1"`
...
// MemberListRes defines the platform member list response.
