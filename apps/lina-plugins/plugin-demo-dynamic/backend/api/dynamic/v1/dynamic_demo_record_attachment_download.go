...
type DownloadDemoRecordAttachmentReq struct {
	g.Meta `path:"/demo-records/{id}/attachment" method:"get" tags:"动态插件示例" summary:"下载动态插件示例附件" dc:"下载一条 plugin-demo-dynamic 示例记录当前关联的附件文件，用于演示动态插件页面对插件自有存储文件的读取能力" access:"login" permission:"plugin-demo-dynamic:record:view" operLog:"other"`
