...
CREATE TABLE IF NOT EXISTS plugin_monitor_operlog (
    ...
    route_owner     VARCHAR(100)  NOT NULL DEFAULT '' COMMENT '路由归属（core或插件ID）',
    route_method    VARCHAR(20)   NOT NULL DEFAULT '' COMMENT '路由请求方式',
    route_path      VARCHAR(255)  NOT NULL DEFAULT '' COMMENT '路由路径',
    route_doc_key   VARCHAR(255)  NOT NULL DEFAULT '' COMMENT 'API文档结构化键',
