...
('登录展示-页面说明', 'sys.auth.pageDesc', '核心宿主服务、默认管理工作台与插件扩展能力', '控制登录页顶部说明文案。', NOW(), NOW()),
('登录展示-登录副标题', 'sys.auth.loginSubtitle', '请输入您的帐户信息以开始管理您的项目', '控制登录表单上方的提示说明文案。', NOW(), NOW()),
('登录展示-登录框位置', 'sys.auth.loginPanelLayout', 'panel-center', '控制登录框默认布局，可选值：panel-left、panel-center、panel-right。', NOW(), NOW()),
