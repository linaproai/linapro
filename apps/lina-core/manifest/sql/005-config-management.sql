...
(0, '登录展示-登录框位置', 'sys.auth.loginPanelLayout', 'panel-right', 'select', '[{"label":"左侧","value":"panel-left"},{"label":"居中","value":"panel-center"},{"label":"右侧","value":"panel-right"}]', 1, '控制登录框默认布局，可选值：panel-left、panel-center、panel-right。', NOW(), NOW()),
