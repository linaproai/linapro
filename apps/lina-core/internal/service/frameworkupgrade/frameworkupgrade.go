// Package frameworkupgrade implements source-upgrade planning and execution for
// LinaPro framework releases.
...
type Plan struct {
	...
	CurrentFramework config.MetadataFrameworkInfo // CurrentFramework stores framework metadata from the current project.
	TargetFramework  config.MetadataFrameworkInfo // TargetFramework stores framework metadata from the target release.
	CurrentVersion   string                       // CurrentVersion is the current project framework version.
	TargetVersion    string                       // TargetVersion is the target framework version from metadata.yaml.
