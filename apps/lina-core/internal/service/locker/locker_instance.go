...
// LockInstance represents a distributed lock instance.
...
func (i *LockInstance) ID() int64 {
	return i.id
}

// Holder returns the current lock holder token.
func (i *LockInstance) Holder() string {
	return i.holder
}
...
func (i *LockInstance) Unlock(ctx context.Context) error {
...
func (i *LockInstance) Renew(ctx context.Context) error {
	now := gtime.Now()
...
func (i *LockInstance) IsHeld(ctx context.Context) (bool, error) {
