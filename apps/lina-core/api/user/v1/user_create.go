...
type CreateReq struct {
	...
	Username string `json:"username" v:"required|length:2,64#validation.user.create.username.required|validation.user.create.username.length" dc:"用户名" eg:"zhangsan"`
	Password string `json:"password" v:"required|length:6,32#validation.user.create.password.required|validation.user.create.password.length" dc:"密码" eg:"123456"`
