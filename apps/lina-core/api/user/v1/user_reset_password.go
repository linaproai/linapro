...
type ResetPasswordReq struct {
	...
	Password string `json:"password" v:"required|length:5,20#validation.user.resetPassword.password.required|validation.user.resetPassword.password.length" dc:"新密码" eg:"123456"`
}
