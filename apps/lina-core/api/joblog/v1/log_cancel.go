...
type CancelReq struct {
	g.Meta `path:"/job/log/{id}/cancel" method:"post" tags:"任务执行日志" summary:"终止运行实例" dc:"终止指定运行中的任务实例；Shell 实例还需通过 system:job:shell 的附加权限校验" permission:"system:joblog:cancel"`
