...
type UpdateReq struct {
	g.Meta `path:"/job/{id}" method:"put" tags:"定时任务管理" summary:"更新任务" operLog:"update" dc:"根据任务ID更新用户自建 Shell 定时任务配置；源码注册任务只允许查看和触发，不允许通过公共接口修改" permission:"system:job:edit"`
