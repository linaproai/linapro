...
type TriggerReq struct {
	g.Meta `path:"/job/{id}/trigger" method:"post" tags:"任务调度/定时任务" summary:"手动触发任务" operLog:"other" dc:"立即触发指定任务执行一次，记录 trigger=manual 的执行日志" permission:"system:job:trigger"`
