...
type DataByTypeReq struct {
	g.Meta   `path:"/dict/data/type/{dictType}" method:"get" tags:"Dictionary Management" summary:"Get dictionary data by type" dc:"Obtain all normal dictionary data items of this type based on the dictionary type key for reuse by the selector, filter or form option of the management workbench." permission:"system:dict:query"`
