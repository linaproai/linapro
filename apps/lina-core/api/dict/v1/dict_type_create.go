...
type TypeCreateReq struct {
	...
	Name   string `json:"name" v:"required#validation.dict.type.create.name.required" dc:"字典名称" eg:"用户性别"`
	Type   string `json:"type" v:"required#validation.dict.type.create.type.required" dc:"字典类型标识（唯一）" eg:"sys_user_sex"`
