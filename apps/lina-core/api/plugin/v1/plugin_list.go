...
type ListReq struct {
	...
	Installed *int   `json:"installed" dc:"按安装状态筛选：1=已安装 0=未安装，不传则查询全部" eg:"1"`
}
...
type PluginItem struct {
	...
	Installed              int                          `json:"installed" dc:"安装状态：1=已安装 0=未安装；源码插件被宿主发现后默认仍可处于未安装态" eg:"1"`
	InstalledAt            string                       `json:"installedAt" dc:"插件安装时间，未安装时返回空字符串" eg:"2026-01-01 12:00:00"`
	Enabled                int                          `json:"enabled" dc:"启用状态：1=启用 0=禁用" eg:"1"`
	AutoEnableManaged      int                          `json:"autoEnableManaged" dc:"是否被宿主主配置文件中的 plugin.autoEnable 命中：1=是 0=否；命中后表示宿主启动时会确保该插件处于启用状态" eg:"1"`
