...
type LoginReq struct {
	...
	Username string `json:"username" v:"required#validation.auth.login.username.required" dc:"用户名" eg:"admin"`
	Password string `json:"password" v:"required#validation.auth.login.password.required" dc:"密码" eg:"admin123"`
}
