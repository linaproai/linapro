...
export function localizeSeedMenuName(rawValue: string | null | undefined) {
  const mapped = localizeByMap(rawValue, {
    ...
    参数导入: 'Import Parameters',
    参数导出: 'Export Parameters',
    参数新增: 'Create Parameter',
    参数设置: 'Parameter Settings',
    字典修改: 'Edit Dictionary',
    字典删除: 'Delete Dictionary',
    字典导入: 'Import Dictionaries',
    字典导出: 'Export Dictionaries',
    字典新增: 'Create Dictionary',
    字典管理: 'Dictionaries',
    字典查询: 'Query Dictionaries',
    岗位修改: 'Edit Position',
    岗位删除: 'Delete Position',
    岗位导出: 'Export Positions',
    岗位新增: 'Create Position',
    岗位查询: 'Query Positions',
    岗位管理: 'Positions',
    工作台: 'Workspace',
    ...
    任务修改: 'Edit Job',
    任务删除: 'Delete Job',
    任务启停: 'Toggle Job Status',
    任务新增: 'Create Job',
    任务查询: 'Query Jobs',
    任务管理: 'Jobs',
    任务调度: 'Scheduler',
    任务重置: 'Reset Job Counter',
    任务日志清理: 'Job Log Cleanup',
    仅本人数据权限: 'Self Only',
    角色修改: 'Edit Role',
    角色删除: 'Delete Role',
    角色新增: 'Create Role',
    角色授权用户: 'Role User Assignment',
    角色管理: 'Roles',
    用户删除: 'Delete User',
    用户新增: 'Create User',
    用户查询: 'Query Users',
    ...
    插件详情: 'Plugin Details',
    插件安装: 'Install Plugin',
    插件卸载: 'Uninstall Plugin',
    数据权限: 'Data Scope',
    新增通知公告: 'Create Notice',
    普通用户: 'Standard User',
    权限字符: 'Permission Key',
    消息列表: 'Messages',
    源码插件: 'Source Plugin',
    ...
    菜单修改: 'Edit Menu',
    菜单查询: 'Query Menus',
    角色授权: 'Role Assignment',
    通知公告: 'Notices',
    部门删除: 'Delete Department',
    部门新增: 'Create Department',
    部门查询: 'Query Departments',
    部门管理: 'Departments',
