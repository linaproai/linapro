...
func commandRegistry() map[string]commandSpec {
	specs := []commandSpec{
		...
		{Name: "dev", Description: "Restart backend and frontend development services.", Usage: "linactl dev [dir=<path>] [backend_port=9120] [frontend_port=5666] [plugins=auto|0|1] [skip_wasm=true]", Run: runDev},
		...
		{Name: "build", Description: "Build frontend assets, plugin artifacts, and host binaries.", Usage: "linactl build [dir=<path>] [plugins=auto|0|1] [platforms=linux/amd64] [verbose=1]", Run: runBuild},
